...
public class EgovSampleController {
	...
	public String listUp(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model) throws Exception {
		...
		// 목록 나오게 하기
		List<?> listUp = sampleService.listUp(searchVO);
		model.addAttribute("resultList", listUp);
	...
	public String listDetail(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model) throws Exception {
		// 목록 나오게 하기
		List<?> listDetail = sampleService.listDetail(searchVO);
